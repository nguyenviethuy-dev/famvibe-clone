    ...
    return (
      <div className="px-14 py-4">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 p-4">
          ...
          <div className="col-span-3 lg:col-span-2 row-span-2 lg:row-span-2 bg-pink-100 rounded-2xl p-8 relative overflow-hidden flex items-center h-[400px]">
            <img
          ...
          {/* Easter Collection */}
          <div className="col-span-3 lg:col-span-1 bg-pink-200 rounded-2xl p-6 relative text-center overflow-hidden flex items-center ">
            <img
          ...
          {/* Gift For Kid */}
          <div className="col-span-3 lg:col-span-1 bg-yellow-200 rounded-2xl p-6 relative text-center overflow-hidden flex items-center ">
            <img
