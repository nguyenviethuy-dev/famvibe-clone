...
//                 <span>Subtotal</span>
//                 <span>${state.items.reduce((sum, item) => sum + item.price, 0).toFixed(2)}</span>
//               </div>
//               <hr className="my-4" />
...
//               </div>
//             </div>
//             <Button className="w-full mt-6">Checkout now</Button>
//           </Card>
//         </div>
//       </div>
//     </div>
            ...
            <div className="flex gap-4">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-3 mt-4">
                  <button className="border rounded p-2" onClick={() => setHasShippingProtection(false)}>
                    <Minus className="w-4 h-4" />
                  </button>
                  <span>{hasShippingProtection ? 1 : 0}</span>
                  <button className="border rounded p-2" onClick={() => setHasShippingProtection(true)}>
        ...
        <div className="space-y-6">
          <Card className="p-6">
            ...
            <div className="space-y-3 mt-6">
              <Button className="w-full bg-[#DC2626] hover:bg-[#DC2626]/90">Checkout now</Button>
              <Button className="w-full bg-[#ffc439] hover:bg-[#ffc439]/90">
            ...
            <div className="mt-6 space-y-5">
              ...
              <Button variant="link" className="w-full" onClick={() => navigate(-1)}>
                Continue Shopping
              </Button>
            </div>
          </Card>
