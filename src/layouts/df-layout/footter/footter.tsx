  ...
  return (
    <footer className="bg-black text-white">
      <div className="container mx-auto px-4 py-8">
        {/* Newsletter Section */}
        <div className="max-w-2xl mx-auto text-center mb-16">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4">Unlock 10% OFF Your First Order!</h2>
          <p className="text-gray-300 mb-8">
          ...
          <form className="space-y-4">
            <Input
              type="text"
              placeholder="First Name"
              className="bg-white text-black rounded-lg px-4 py-3 w-full text-base sm:text-lg"
            />
            <Input
              type="email"
              placeholder="Enter your email address..."
              className="bg-white text-black rounded-lg px-4 py-3 w-full text-base sm:text-lg"
            />
            <Button className="w-full bg-red-500 hover:bg-red-600 text-white text-base sm:text-lg font-bold py-3 rounded-lg uppercase">
              Unlock Your 10% OFF NOW
            </Button>
          </form>
        </div>
        ...
        {/* Footer Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 pt-8 border-t border-gray-800">
          {/* Logo Column */}
          <div className="space-y-4">
            <Link to="/">
              <img
                src="https://famvibe.com/cdn/shop/t/358/assets/LOGO-TAGLINE-white-Rebranding-desktop.svg?v=172560154624512658651738572443"
                alt="Famvibe Logo"
                className="mb-4 cursor-pointer max-w-full h-auto"
              />
            </Link>
            {/* Add other logo column content */}
          </div>
          ...
          <div>
            ...
            <div className="relative flex flex-wrap gap-4">
              ...
              >
                <img
                  src={currencies.find((c) => c.code === currency)?.flag || "/placeholder.svg"}
                  alt={currency}
                ...
                <div className="absolute left-0 mt-2 w-28 bg-white border border-gray-300 rounded-lg shadow-md">
                  {currencies.map((item) => (
                    <button
                      ...
                      className="flex items-center gap-2 px-3 py-2 w-full text-left hover:bg-gray-100 text-black"
                    >
                      <img src={item.flag || "/placeholder.svg"} alt={item.code} className="w-6 h-4 rounded-sm" />
                      <span>{item.code}</span>
                    </button>
                  ))}
                </div>
      ...
      <div className="bg-red-700 text-white text-center py-4">
        <p className="text-sm">© 2023 Famvibe Store. Powered by Shopify</p>
      </div>
    </footer>
  )
}
