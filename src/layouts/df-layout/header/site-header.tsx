            ...
            <div className="flex-1 relative">
              <div className="relative">
                ...
                <input
                  type="search"
                  placeholder="Search"
                  className="w-full pl-10 pr-4 py-2.5 text-base border rounded-tl-3xl rounded-br-3xl rounded-tr-3xl rounded-bl-3xl focus:outline-none focus:ring-2 focus:ring-primary"
                />
              </div>
            </div>
